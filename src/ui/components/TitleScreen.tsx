export function TitleScreen({ highScore }: { highScore: number }) {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 bg-zinc-950/85 font-mono">
      <h1 className="text-5xl font-bold tracking-[0.3em] text-cyan-300 drop-shadow-[0_0_18px_rgba(34,211,238,0.7)]">
        TERRITORY
      </h1>
      <h1 className="-mt-4 text-5xl font-bold tracking-[0.3em] text-fuchsia-400 drop-shadow-[0_0_18px_rgba(217,70,239,0.7)]">
        RAIDER
      </h1>
      {highScore > 0 && (
